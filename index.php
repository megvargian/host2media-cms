    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-12 gap-5 py-10 lg:mx-0 mx-5">
            <div class="col-span-4 bg-[#FFF9F9] sm:p-5 p-3 rounded-[10px] text-left">
                ...
                <p class="text-[#0F132A] Mulish-Regular pb-4">Understanding the FundamentalsMuch like many organizations, you probably opted for cloud computing when you first launched your web application, database, or mail server...</p>
        ...
        <div class="grid grid-cols-12 gap-5 py-10 lg:mx-0 mx-5">
            <div class="col-span-6 bg-[#FFF9F9] sm:p-5 p-3 rounded-[10px] text-left">
                <div class="sm:pb-10 pb-5">
                    <img
                        class="w-full"
                        src="<?php echo get_template_directory_uri(); ?>/inc/assets/images/dedicated-server-bg.png"
